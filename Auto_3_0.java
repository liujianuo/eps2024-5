...
public class Auto_3_0 extends LinearOpMode{
    ...
    protected static final double KI = 0.0015;
    ...
    protected static final double buffertime = 0.11;
    ...
    */
    ...
    public void runOpMode(){
        ...
        fbPID(1280, 0.45); // approach sub
        linear.setPower(0);
        
        linear.setPower(-1);
        pause(0.8, "score"); //score
        linear.setPower(0);
