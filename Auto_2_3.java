...
@Autonomous(name="40+3")
public class Auto_2_3 extends LinearOpMode{
    // Define all motors
    DcMotor rightback;
    DcMotor leftback;
    DcMotor rightfront;
    ...
    */
    ...
    public void runOpMode(){
        ...
        linear.setPower(-0.79);
        rlPID(1400, 1.1); //line up 
        linear.setPower(0);
